...
### KLM -- version to use within shell script, reports just BLEU score
...
while(<STDIN>) {
    ...
    ###SHH print "reference: $referenceLine\n";
    ###SHH print "hypothesis: $hypothesisLine\n\n"; 
      #print "$s $_ <=> $reference\n";
...
if ($length_translation_this_sentence<$closest_length) {
	###SHH print "translation shorter than reference, assessing brevity penalty\n";
...
###SHH print "reference length $closest_length, translation length $length_translation_this_sentence\n";
###SHH print "brevity penalty $sentence_brevity_penalty\n"; 
...
if ($sentence_CORRECT[4]>0) {
	###SHH print "normal multi-bleu scoring\n"; 
	...
	if ($sentence_TOTAL[4]>0) {
		###SHH print "no 4-gram matches, smoothing 4-gram count to 0.5\n"; 
		...
		###SHH print "no 4-grams in hypothesis, calculating BLEU for trigrams\n";
		$sentence_bleu = $sentence_brevity_penalty * exp((my_log( $sentence_CORRECT[1]/$sentence_TOTAL[1] ) +
				my_log( $sentence_CORRECT[2]/$sentence_TOTAL[2] ) +
	...
	if ($sentence_TOTAL[4]>0) {
		###SHH print "no trigram matches, smoothing trigram count to 0.5, smoothing 4-gram count to 0.25\n";
		...
		###SHH print "no 4-grams in hypothesis, calculating BLEU for trigrams\n";
		###SHH print "no trigram matches, smoothing trigram count to 0.5\n";
		$sentence_trigram = 0.5;
		$sentence_bleu = $sentence_brevity_penalty * exp((my_log( $sentence_CORRECT[1]/$sentence_TOTAL[1] ) +
				my_log( $sentence_CORRECT[2]/$sentence_TOTAL[2] ) +
				my_log( $sentence_CORRECT[3]/$sentence_TOTAL[3] )) / 3);		
		...
		###SHH print "no 4-grams or trigrams in hypothesis, calculating BLEU for bigrams\n";
		$sentence_bleu = $sentence_brevity_penalty * exp((my_log( $sentence_CORRECT[1]/$sentence_TOTAL[1] ) +
	...
	if ($sentence_TOTAL[4]>0) {
		###SHH print "no bigram matches, smoothing bigram count to 0.5, trigram count to 0.25, and 4-gram count to 0.125\n";
		$sentence_bigram = 0.5; 
		...
		# prevent division by 0 for 4-grams
		###SHH print "no 4-grams in hypothesis, calculating BLEU for trigrams\n";
		###SHH print "no bigram matches, smoothing bigram count to 0.5, trigram count to 0.25\n";
		$sentence_bigram = 0.5; 
		$sentence_trigram = 0.25;
		$sentence_bleu = $sentence_brevity_penalty * exp((my_log( $sentence_CORRECT[1]/$sentence_TOTAL[1] ) +
				my_log( $sentence_CORRECT[2]/$sentence_TOTAL[2] ) +
		...
		###SHH print "no 4-grams or trigrams in hypothesis, calculating BLEU for bigrams\n";
		###SHH print "no bigram matches, smoothing bigram count to 0.5\n";
		$sentence_bigram = 0.5; 
		$sentence_bleu = $sentence_brevity_penalty * exp((my_log( $sentence_CORRECT[1]/$sentence_TOTAL[1] ) +
				my_log( $sentence_CORRECT[2]/$sentence_TOTAL[2] )) / 2);
	} else {
		...
		###SHH print "no 4-grams, trigrams, or bigrams in hypothesis, calculating BLEU for unigrams\n";
		$sentence_bleu = $sentence_brevity_penalty * exp((my_log( $sentence_CORRECT[1]/$sentence_TOTAL[1] )));
...
### FULL printf "BLEU = %.2f, %.1f/%.1f/%.1f/%.1f \n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$closest_length\n",
### FULL    100*$sentence_bleu,
### FULL    100*$sentence_CORRECT[1]/$sentence_TOTAL[1],
### FULL    100*$sentence_CORRECT[2]/$sentence_TOTAL[2],
### FULL    100*$sentence_CORRECT[3]/$sentence_TOTAL[3],
### FULL    100*$sentence_CORRECT[4]/$sentence_TOTAL[4],
### FULL    $sentence_brevity_penalty,
### FULL   $length_translation_this_sentence/$closest_length;
      # $length_translation / $length_reference;
   #print "reference length $closest_length, translation length $length_translation_this_sentence\n";
   ### TRY print "$sentence_bleu\n";
   print STDOUT "$sentence_bleu\n";
...
###SHH print "[no 4-grams]\n"; 
# printf "BLEU = %.2f, %.1f/%.1f/%.1f/\n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$length_reference\n",
### FULL printf "BLEU = %.2f, %.1f/%.1f/%.1f/\n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$closest_length\n",
### FULL    100*$sentence_bleu,
### FULL    100*$sentence_CORRECT[1]/$sentence_TOTAL[1],
### FULL    100*$sentence_CORRECT[2]/$sentence_TOTAL[2],
### FULL    100*$sentence_CORRECT[3]/$sentence_TOTAL[3],
...
###SHH print "[no 4-grams or trigrams]\n"; 
#printf "BLEU = %.2f, %.1f/%.1f//\n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$length_reference\n",
### FULL printf "BLEU = %.2f, %.1f/%.1f//\n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$closest_length\n",
### FULL    100*$sentence_bleu,
### FULL    100*$sentence_CORRECT[1]/$sentence_TOTAL[1],
### FULL    100*$sentence_CORRECT[2]/$sentence_TOTAL[2],
...
###SHH print "[no 4-grams or trigrams or bigrams]\n"; 
#printf "BLEU = %.2f, %.1f///\n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$length_reference\n",
### FULL printf "BLEU = %.2f, %.1f///\n(BP=%.3f, ration=%.3f):$sentence_CORRECT[1]:$sentence_TOTAL[1]:=$sentence_CORRECT[2]:total=$sentence_TOTAL[2]:$sentence_CORRECT[3]:$sentence_TOTAL[3]:$sentence_CORRECT[4]:$sentence_TOTAL[4]:$closest_length\n",
### FULL    100*$sentence_bleu,
### FULL    100*$sentence_CORRECT[1]/$sentence_TOTAL[1],
...
###SHH print "reference length $length_reference, translation length $length_translation\n";
###SHH print "brevity penalty $brevity_penalty\n"; 
...
### FULL    100*$bleu,
### FULL    100*$CORRECT[1]/$TOTAL[1],
### FULL    100*$CORRECT[2]/$TOTAL[2],
### FULL    100*$CORRECT[3]/$TOTAL[3],
### FULL    100*$CORRECT[4]/$TOTAL[4],
### FULL    $brevity_penalty,
### FULL    $length_translation / $length_reference;
### TOTAL    print $bleu;
